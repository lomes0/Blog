...
| [upstream-scrub.md](./upstream-scrub.md)                   | Proposal, scope locked, **Phase 0 done (7 Aug 2026)** — delete the demo surface the math-editor fork left (`/tutorial`, `/playground`, one orphan font). All editor nodes and the collab surface stay; git history untouched. Phases 1–6 unblocked  |
