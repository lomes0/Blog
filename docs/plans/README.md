...
| [agent-gating.md](./agent-gating.md)                       | Proposal — agent writes land as *proposals*, reviewed and approved in the app before they become the document. Builds on the content bridge and the `head` compare-and-set; phases 1–4 are the walking skeleton |
