                ...
                {formats.includes("embed") &&
                  ...
                  <Box sx={{ p: 2 }}>
                    ...
                    >
                      ...
                      {isPrivate && (
                        <FormHelperText>
                          Private documents can not be embedded
                        </FormHelperText>
                      )}
                    </FormControl>
                  </Box>
                )}
                {formats.includes("pdf") && format === "pdf" &&
                  (
                    <Box sx={{ p: 2 }}>
                      <FormControl
                        fullWidth
